...
async function highlightPreview(code: string, lang: "mdx" | "shellscript") {
...
export default ilha
  ...
  .derived("previews", async () => ({
    fileTree: await highlightPreview(fileTreeCode, "shellscript"),
    mdxSyntax: await highlightPreview(mdxSyntaxCode, "mdx"),
    buildOutput: await highlightPreview(buildOutputCode, "shellscript"),
  }))
  .render(({ derived }) => {
          ...
          <section class="container max-w-6xl mx-auto px-4 py-14 sm:py-20 lg:py-28">
            <div class="mx-auto max-w-4xl text-center flex flex-col items-center gap-6">
              ...
              <ClipboardText.Static
                text="npx giget@latest gh:ilhajs/luz my-docs"
                tooltip
