...
/** Run once after static hydration — MDX islands only (no extra Ilha slot). */
export function runDocMdxEnhancements(root: ParentNode = document) {
  mountMdxIslandsInRoot(root);
}
